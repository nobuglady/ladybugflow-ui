	...
	$.jstree.core.prototype = {
      ...
      if (obj && $.inArray(obj.id, this._model.changed) === -1) {
		...
		create_node : function (par, node, pos, callback, is_loaded) {
			...
			request_catagory_create(node)//#test
		...
		rename_node : function (obj, val) {
			...
			request_catagory_rename(obj)//#test
		...
		delete_node : function (obj) {
			...
			var deleteIdList = [];// #test
			for(k = 0, l = tmp.length; k < l; k++) {// #test
			  deleteIdList.push(this._model.data[tmp[k]].id); // #test
			}// #test
			...
			request_catagory_delete(deleteIdList)//#test
		...
		move_node : function (obj, par, pos, callback, is_loaded, skip_redraw, origin) {
			...
			request_catagory_move(obj)//#test
		...
		copy_node : function (obj, par, pos, callback, is_loaded, skip_redraw, origin) {
			...
			request_catagory_copy(tmp)//#test
